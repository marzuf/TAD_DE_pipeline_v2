...
script_name <- "4cond1_runMeanTADCorr"
...
stopifnot(samp1 %in% colnames(norm_rnaseqDT))
norm_rnaseqDT <- norm_rnaseqDT[,c(samp1)]
...
save(all_meanCorr_TAD_cond1, file= paste0(curr_outFold, "/all_meanCorr_TAD_cond1.Rdata"))
cat(paste0("... written: ", curr_outFold, "/all_meanCorr_TAD_cond1.Rdata", "\n"))
