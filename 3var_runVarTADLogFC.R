...
script_name <- "3var_runVarTADLogFC"
...
mean_DT <- aggregate(logFC ~ region, data=mergedDT, FUN=var)
...
save(all_meanLogFC_TAD, file= paste0(curr_outFold, "/all_varLogFC_TAD.Rdata"))
cat(paste0("... written: ", curr_outFold, "/all_varLogFC_TAD.Rdata", "\n"))
