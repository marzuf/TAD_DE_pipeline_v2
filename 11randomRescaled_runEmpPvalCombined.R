...
# - script9random: emp_pval_meanLogFC.Rdata
# - script10random: emp_pval_meanCorr.Rdata
################################################################################
...
script9random_name <- "9randomRescaled_runEmpPvalMeanTADLogFC"

#cat("!!! WARNING: USE 10000 PERMUTATIONS DATA !!!\n")

script10random_name <- "10random_runEmpPvalMeanTADCorr"
script_name <- "11randomRescaled_runEmpPvalCombined"
...
emp_pval_logFC <- eval(parse(text = load(file.path(pipOutFold,  script9random_name, "emp_pval_meanLogFC.Rdata"))))

# load emp. p-val intraTAD corr
emp_pval_intraCorr <- eval(parse(text = load(file.path(pipOutFold, script10random_name, "emp_pval_meanCorr.Rdata"))))
