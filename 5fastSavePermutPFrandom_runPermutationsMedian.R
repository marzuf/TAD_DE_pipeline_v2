...
# different script for the random data -> input purtiy filtering from PREP_DATA_PURITYFILTER_RANDOM
...
script_name <- "5pF_runPermutationsMedian"  #  same  as for the non random
