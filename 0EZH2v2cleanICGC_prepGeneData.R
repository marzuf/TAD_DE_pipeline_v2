...
## UPDATE 06.07.2018 checked manually, this is ok - at least for the ELISA data (few samples...) - it is not an error if duplicated rows, check also that no rows are all equal 0
if(rnaseqDT_file != "/mnt/ed4/marie/scripts/EZH2_final_MAPQ/GENE_DATA_MZ/ELISA/wt_mut_elisa_tpm_exprDT.Rdata") {
