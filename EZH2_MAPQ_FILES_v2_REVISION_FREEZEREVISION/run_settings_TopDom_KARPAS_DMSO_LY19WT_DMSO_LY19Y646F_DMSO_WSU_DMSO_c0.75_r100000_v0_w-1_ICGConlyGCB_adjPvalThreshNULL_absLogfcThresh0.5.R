# > file written: Thu, 21 Jun 2018 09:12:19 +0200 
# *** EXPECTED FORMAT:
...
pipOutFold <- "/mnt/ed4/marie/scripts/TAD_DE_pipeline_v2/OUTPUT_FOLDER_EZH2_MAPQ_v2_REVISION_adjPvalThreshNULL_absLogfcThresh0.5_ICGConlyGCB/TopDom_KARPAS_DMSO_LY19WT_DMSO_LY19Y646F_DMSO_WSU_DMSO_c0.75_r100000_v0_w-1"
...
rnaseqDT_file <- "/mnt/ed4/marie/scripts/EZH2_final_MAPQ/GENE_DATA_MZ/ICGC/ICGConlyGCB/mrna_data.HGNC_GCBonly_noAllZeroWtMut_RNAseq_MZ.RData"
my_sep <- "\t"
...
gene_adjPvalThresh <- NULL
gene_absLogfcThresh <- 0.5
...
sample1_file <- "/mnt/ed4/marie/scripts/EZH2_final_MAPQ/GENE_DATA_MZ/ICGC/ICGConlyGCB/wt_ID.Rdata"
sample2_file <- "/mnt/ed4/marie/scripts/EZH2_final_MAPQ/GENE_DATA_MZ/ICGC/ICGConlyGCB/mut_ID.Rdata"
