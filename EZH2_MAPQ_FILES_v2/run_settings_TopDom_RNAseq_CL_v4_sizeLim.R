...
pipOutFold <- "/mnt/ed4/marie/scripts/TAD_DE_pipeline_v2/OUTPUT_FOLDER_EZH2_MAPQ_v2_RNAseq/RNAseq_CL_v4_sizeLim"

# for the RNAseq data
microarray <- FALSE # emulate 

# OVERWRITE THE DEFAULT SETTINGS FOR INPUT FILES # there are the same as for EZH2
TADpos_file <- paste0(setDir, "/mnt/ed4/marie/scripts/EZH2_final_MAPQ/GENE_DATA_MZ/RNAseq_v4/TADposDT.txt")
#chr1    chr1_TAD1       750001  1300000
#chr1    chr1_TAD2       2750001 3650000
#chr1    chr1_TAD3       3650001 4150000

gene2tadDT_file <- paste0(setDir, "/mnt/ed4/marie/scripts/EZH2_final_MAPQ/GENE_DATA_MZ/RNAseq_v4/gene2tadDT.txt")
...
#NOC2L   NOC2L
            # CHANGED V2 !!!!
entrezDT_file <- paste0(setDir, "/mnt/ed4/marie/scripts/EZH2_final_MAPQ/GENE_DATA_MZ/RNAseq_v4/entrezDT.txt")
...
# => for the RNAseq, set to 1 because few TADs -> TRY TO SET LIMIT IN THIS VERSION
maxQuantGeneTAD <- 0.99

# FOR RNAseq data from EZH2 -> do not impose filter on nbr of genes/TAD -> TRY TO SET LIMIT IN THIS VERSION
minNbrGeneTAD <- 3
