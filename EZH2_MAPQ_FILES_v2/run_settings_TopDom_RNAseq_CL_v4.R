...
pipOutFold <- "/mnt/ed4/marie/scripts/TAD_DE_pipeline_v2/OUTPUT_FOLDER_EZH2_MAPQ_v2_RNAseq/RNAseq_CL_v4"
...
# => for the RNAseq, set to 1 because few TADs
maxQuantGeneTAD <- 1

# FOR RNAseq data from EZH2 -> do not impose filter on nbr of genes/TAD
minNbrGeneTAD <- 1
