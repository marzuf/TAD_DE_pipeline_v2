...
#sameNbrTopDom -> take correlation values for random model from v2_Yuanlong_Cancer_TAD_DA folder
# (otherwise not enough values for the moment)
...
## HACK HERE 22.08.2020 -> To have corr values for all datasets -> take the same as YL data
mainPipFold <- "/mnt/etemp/marie/v2_Yuanlong_Cancer_HiC_data_TAD_DA/PIPELINE/OUTPUT_FOLDER"
