...
# - script4partial: all_meanCorr_TAD.Rdata
# - script7sameNbrPartial: meanCorr_sample_around_TADs_sameNbr.Rdata
################################################################################
...
script_name <- "10sameNbrPartial_runEmpPvalMeanTADCorr"
