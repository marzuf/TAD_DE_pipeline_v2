...
# > file written: Wed, 11 Jul 2018 14:57:13 +0200 
# *** EXPECTED FORMAT:
...
pipOutFold <- "/mnt/ed4/marie/scripts/TAD_DE_pipeline_v2/OUTPUT_FOLDER_EZH2_MAPQ_v2_REVISION_ELISAhackedvLatest/TopDom_KARPAS_DMSO_LY19WT_DMSO_LY19Y646F_DMSO_WSU_DMSO_c0.75_r100000_v0_w-1"
...
rnaseqDT_file <- "/mnt/ed4/marie/scripts/EZH2_final_MAPQ/GENE_DATA_MZ/ELISAhackedvLatest/wt_mut_elisa_tpm_exprDT_vLatest.Rdata"
my_sep <- "\t"
...
sample1_file <- "/mnt/ed4/marie/scripts/EZH2_final_MAPQ/GENE_DATA_MZ/ELISAhackedvLatest/wt_ID.Rdata"
sample2_file <- "/mnt/ed4/marie/scripts/EZH2_final_MAPQ/GENE_DATA_MZ/ELISAhackedvLatest/mut_ID.Rdata"
