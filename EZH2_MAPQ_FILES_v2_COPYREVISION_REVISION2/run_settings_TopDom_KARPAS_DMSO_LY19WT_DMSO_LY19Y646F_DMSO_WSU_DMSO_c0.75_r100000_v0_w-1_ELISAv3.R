# > file written: Wed, 11 Jul 2018 10:04:46 +0200 
# *** EXPECTED FORMAT:
...
pipOutFold <- "/mnt/ed4/marie/scripts/TAD_DE_pipeline_v2/OUTPUT_FOLDER_EZH2_MAPQ_v2_REVISION_ELISAv3/TopDom_KARPAS_DMSO_LY19WT_DMSO_LY19Y646F_DMSO_WSU_DMSO_c0.75_r100000_v0_w-1"
...
#NOC2L   NOC2L
            # CHANGED V2 !!!!
entrezDT_file <- paste0(setDir, "/mnt/ed4/marie/scripts/EZH2_final_MAPQ/GENE_DATA_MZ/ELISAv3/extended_annot_file.txt")
...
rnaseqDT_file <- "/mnt/ed4/marie/scripts/EZH2_final_MAPQ/GENE_DATA_MZ/ELISAv3/wt_mut_elisa_tpm_exprDT_v3.Rdata"
my_sep <- "\t"
...
sample1_file <- "/mnt/ed4/marie/scripts/EZH2_final_MAPQ/GENE_DATA_MZ/ELISAv3/wt_ID.Rdata"
sample2_file <- "/mnt/ed4/marie/scripts/EZH2_final_MAPQ/GENE_DATA_MZ/ELISAv3/mut_ID.Rdata"
