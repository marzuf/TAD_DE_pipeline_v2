# > file written: Fri, 29 Jun 2018 14:21:28 +0200 
# *** EXPECTED FORMAT:
...
pipOutFold <- "/mnt/ed4/marie/scripts/TAD_DE_pipeline_v2/OUTPUT_FOLDER_EZH2_MAPQ_v2_REVISION_ICGConlyFLall/TopDom_KARPAS_DMSO_LY19WT_DMSO_LY19Y646F_DMSO_WSU_DMSO_c0.75_r100000_v0_w-1"
...
rnaseqDT_file <- "/mnt/ed4/marie/scripts/EZH2_final_MAPQ/GENE_DATA_MZ/ICGC/ICGConlyFLall/mrna_data.HGNC_FLonlyAll_noAllZeroWtMut_RNAseq_MZ.RData"
my_sep <- "\t"
...
sample1_file <- "/mnt/ed4/marie/scripts/EZH2_final_MAPQ/GENE_DATA_MZ/ICGC/ICGConlyFLall/wt_ID.Rdata"
sample2_file <- "/mnt/ed4/marie/scripts/EZH2_final_MAPQ/GENE_DATA_MZ/ICGC/ICGConlyFLall/mut_ID.Rdata"
