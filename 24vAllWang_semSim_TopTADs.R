...
script_name <- "24vAllWang_semSim_TopTADs"
...
if(semSimMetric != "Wang") stop("-- need to use 24v2 for parallel database access (but will be slower !)\n")
...
nTopTADs_semSim <- length(topTADs)
