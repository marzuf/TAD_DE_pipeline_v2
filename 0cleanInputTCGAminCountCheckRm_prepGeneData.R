...
cat(paste0("> START ", "0cleanInputTCGAminCountCheckRm",  "\n"))
...
script_nameInit <- paste0("0cleanInputTCGAminCountCheckRm_prepGeneData")
cat((paste0(pipScriptDir, "/", script_nameInit, ".R")))
stopifnot(file.exists(paste0(pipScriptDir, "/", script_nameInit, ".R")))
cat(paste0("> START ", script_nameInit,  "\n"))
script_name <- paste0("0_prepGeneDataCheckRm")
...
countFilter_rnaseqDT_noCpmFilter <- countFilter_rnaseqDT[rowsToKeep,]

  save(countFilter_rnaseqDT, file = paste0(curr_outFold, "/", "countFilter_rnaseqDT.Rdata"))
  cat(paste0("... written: ", paste0(curr_outFold, "/", "countFilter_rnaseqDT.Rdata"), "\n"))

  save(countFilter_rnaseqDT_noCpmFilter, file = paste0(curr_outFold, "/", "countFilter_rnaseqDT_noCpmFilter.Rdata"))
  cat(paste0("... written: ", paste0(curr_outFold, "/", "countFilter_rnaseqDT_noCpmFilter.Rdata"), "\n"))

  pipeline_geneList_noCpmFilter <- pipeline_geneList  
  save(pipeline_geneList_noCpmFilter, file = paste0(curr_outFold, "/", "pipeline_geneList_noCpmFilter.Rdata"))
  cat(paste0("... written: ", paste0(curr_outFold, "/", "pipeline_geneList_noCpmFilter.Rdata"), "\n"))
