# > file written: Mon, 18 Jun 2018 18:52:27 +0200 
# *** EXPECTED FORMAT:
...
pipOutFold <- "/mnt/ed4/marie/scripts/TAD_DE_pipeline_v2/OUTPUT_FOLDER_EZH2_MAPQ_v2_REVISION_adjPvalThresh0.9_absLogfcThreshNULL_EPZ/TopDom_KARPAS_DMSO_LY19WT_DMSO_LY19Y646F_DMSO_WSU_DMSO_c0.75_r100000_v0_w-1"
...
rnaseqDT_file <- "/mnt/ed4/marie/scripts/EZH2_final_MAPQ/GENE_DATA_MZ/EPZ/data.collapsed_noDup_MZ.RData"
my_sep <- "\t"
...
designFile <- "/mnt/ed4/marie/scripts/EZH2_final_MAPQ/GENE_DATA_MZ/EPZ/sample_annotations.txt"
...
sample1_file <- "/mnt/ed4/marie/scripts/EZH2_final_MAPQ/GENE_DATA_MZ/EPZ/untreat_ID.Rdata"
sample2_file <- "/mnt/ed4/marie/scripts/EZH2_final_MAPQ/GENE_DATA_MZ/EPZ/treat_ID.Rdata"
