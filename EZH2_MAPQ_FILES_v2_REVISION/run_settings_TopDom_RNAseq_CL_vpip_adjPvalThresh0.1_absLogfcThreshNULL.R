...
# EDIT MANUALL 21.06.2019 FOR THE RNAseq data WITH THRESHOLD

# path to output folder:
pipOutFold <- "/mnt/ed4/marie/scripts/TAD_DE_pipeline_v2/OUTPUT_FOLDER_EZH2_MAPQ_v2_REVISION_adjPvalThresh0.1_absLogfcThreshNULL_RNAseq/RNAseq_CL_vpip"
