...
# => in the TAD DE pipeline this main_settings.R is not used anymore !!! STEP1 is now to use cleanInput and does not use this runWithoutVoom anymore !!!

########################################################
### ADDED 18.06.2018 to threshold genes based on adj.pval and/or logFC
########################################################

#gene_adjPvalThresh <- NULL
#gene_absLogfcThresh <- NULL
# UPDATE: => this is added in the setting file, not here
