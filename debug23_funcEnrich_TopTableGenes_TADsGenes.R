...
script_name <- "debug23_funcEnrich_TopTableGenes_TADsGenes"
...
cat(paste0("... found setting: nTopGSEA = ", nTopTADs, "\n"))
...
################################################################################################################
                      ...
                      cat(paste0(">>> START gseGO with # scores: ", length(all_genes_scores), " - ", Sys.time(), "\n"))

                      print(head(all_genes_scores))
                      print(summary(all_genes_scores))
