...
script_name <- "17fpre_build_score_table_limited_pval"
...
dtFile <- paste0(curr_outFold, "/rank_all_scores_DT_withPval.txt")
...
all_scores_samples_DT <- all_scores_samples_DT[,c("dataset", "process", "cond1", "cond2", "nSamp1", "nSamp2", 
                                                  ...
                                                  tmpCol)]
dtFile <- paste0(curr_outFold, "/rank_all_scores_DT_withSamp_withPval.txt")
...
# }
#  
plotFile <- file.path(curr_outFold, "rank_all_scores_DT_withPval.svg")
...
plotFile <- file.path(curr_outFold, "rank_all_scores_DT_withSamp_withPval.svg")
