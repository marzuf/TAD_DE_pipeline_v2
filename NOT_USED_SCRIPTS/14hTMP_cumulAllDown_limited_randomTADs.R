...
script_name <- "14hTMP_cumulAllDown_limited_randomTADs"
...
stopifnot(any(c(step14_for_randomTADsFix, step14_for_randomTADsGaussian )))
...
for(curr_ratio_type in allDown_limited) {
  ...
  outFile <- paste0(curr_outFold, "/14hTMP_", curr_ratio_type, "_observ_vect.Rdata")
  save(observ_vect, file=outFile)
