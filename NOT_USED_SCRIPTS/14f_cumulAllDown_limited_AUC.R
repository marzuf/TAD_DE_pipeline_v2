...
script_name <- "14f_cumulAllDown_limited_AUC"
stopifnot(file.exists(paste0(pipScriptDir, "/", script_name, ".R")))
cat(paste0("> START ", script_name,  "\n"))

# settingF <- "EZH2_MAPQ_FILES/run_settings_TopDom_KARPAS_DMSO_LY19WT_DMSO_LY19Y646F_DMSO_WSU_DMSO_c0.75_r100000_v0_w-1_CL.R"
# nCpu <- 1
...
# allDown and allDown_limited retrieved from main_settings.R
...
for(curr_ratio_type in allDown_limited) {
    ...
    if(curr_ratio_type == "ratioDown") {
      ...
      plot_cumsumDiff05_AUC(filter_obs_curr_down_half, 
                            filter_permut_currDown_half, 
                            my_stat = my_stat_curr_ratio,
                            departureValue = departureFromValue)
      mtext(subtitDir, font=3)
